...
user_agents = [
    ...
    "Mozilla/5.0 (Macintosh; Intel Mac OS X 11_1_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.88 "
...
params = {'headers': {'user-agent': user_agents[random.randrange(0, len(user_agents))]},
          'url': 'https://e-hentai.org/', 'cookie': {}}
