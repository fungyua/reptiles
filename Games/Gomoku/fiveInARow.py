...
def print_text(screen, font, x, y, text, f_color=(255, 255, 255)):
    img_text = font.render(text, True, f_color)
...
def main():
    ...
    font1 = pygame.font.SysFont('PingFang', 32)
    font2 = pygame.font.SysFont('PingFang', 72)
    f_width, f_height = font2.size('黑方获胜')
    ...
    while True:
        ...
        if winner:
            print_text(screen, font2, (SCREEN_WIDTH - f_width) // 2, (SCREEN_HEIGHT - f_height) // 2,
...
class AI:
    def __init__(self, line_points, chessman):
        self._line_points = line_points
        self._my = chessman
        self._opponent = BLACK_CHESSMAN if chessman == WHITE_CHESSMAN else WHITE_COLOR
        self._checkerboard = [[0] * line_points for _ in range(line_points)]
