...
from error.error import ExOpenError, BanIPError
...
class getindex(object):
    def __init__(self, lastpage=0, toekn=None):
        ...
        self.__excookies = requests.utils.cookiejar_from_dict(config.COOKIE_DICT, cookiejar=None,
                                                              overwrite=True)  # 装载cookie
